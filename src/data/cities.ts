...
export const cities: CityData[] = [
  ...
  },
  {
    ...
    currentTemp: 41,
    currentAQI: 220,
    treeCoverPercent: 10.5,
    urbanHeatIndex: 8.0,
    monthlyTemp: [15, 18, 25, 33, 39, 41, 36, 34, 33, 29, 23, 17],
    monthlyAQI: [260, 240, 210, 180, 160, 150, 130, 135, 155, 210, 270, 280],
    aqiBreakdown: [
      { label: "PM2.5", value: 130 },
      { label: "PM10", value: 210 },
      { label: "NO₂", value: 60 },
      { label: "SO₂", value: 22 },
      { label: "O₃", value: 42 },
      { label: "CO", value: 28 },
  ...
  },
  {
    ...
    currentTemp: 38,
    currentAQI: 175,
    treeCoverPercent: 18.2,
    urbanHeatIndex: 6.8,
    monthlyTemp: [14, 18, 24, 31, 36, 38, 33, 32, 31, 28, 22, 16],
    monthlyAQI: [220, 210, 185, 155, 135, 120, 100, 105, 125, 175, 230, 240],
    aqiBreakdown: [
      { label: "PM2.5", value: 95 },
      { label: "PM10", value: 155 },
      { label: "NO₂", value: 48 },
      { label: "SO₂", value: 18 },
      { label: "O₃", value: 37 },
      { label: "CO", value: 23 },
